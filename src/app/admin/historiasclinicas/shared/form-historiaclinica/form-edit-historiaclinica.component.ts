...
@Component({
    selector: 'app-form-edit-historiaclinica',
    templateUrl: './form-edit-historiaclinica.component.html',
    styleUrls: ['./form-edit-historiaclinica.component.css']
  })
  export class FormEditHistoriaclinicaComponent implements OnInit {
    form: FormGroup;
    mascotas:Mascota[];
